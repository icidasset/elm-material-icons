...
account_tree =
    icon
        [ id "ic_x5F_account_x5F_tree_x5F_icon_x5F_m2sharp_x5F_24px", viewBox "0 0 24 24", enableBackground "new 0 0 24 24" ]
        [ g
            []
            [ rect
                [ fill "none" ]
        ...
        , polygon
            [ points "22,11 22,3 15,3 15,6 9,6 9,3 2,3 2,11 9,11 9,8 11,8 11,18 15,18 15,21 22,21 22,13 15,13 15,16 13,16 13,8 15,8 \n    \t15,11 " ]
            []
        ]
...
phone_enabled =
    icon
        ...
        [ rect
            ...
            []
        , g
            [ id "ic_phone_enabled__m2sharp_24px" ]
            [ g
                [ id "icon" ]
                [ path
                    [ id "path-1_1_", d "M3,15.46l5.27-0.61l2.52,2.52c2.83-1.44,5.15-3.75,6.59-6.59l-2.53-2.53L15.46,3h5.51\n    \t\t\tC21.55,13.18,13.18,21.55,3,20.97V15.46z" ]
                    []
                ]
            ]
        ]
...
queue_music =
    icon
        ...
        , g
            [ id "Sharp" ]
            [ path
                [ d "M15,6H3v2h12V6z M15,10H3v2h12V10z M3,16h8v-2H3V16z M17,6v8.18C16.69,14.07,16.35,14,16,14c-1.66,0-3,1.34-3,3s1.34,3,3,3\n    \t\ts3-1.34,3-3V8h3V6H17z" ]
                []
            ]
        ]
