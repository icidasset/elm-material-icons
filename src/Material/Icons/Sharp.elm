...
@docs approval, attach_email, attachment, cloud, cloud_circle, cloud_done, cloud_download, cloud_off, cloud_queue, cloud_upload, create_new_folder, download, download_done, download_for_offline, downloading, drive_file_move, drive_file_move_rtl, drive_file_rename_outline, drive_folder_upload, file_download, file_download_done, file_download_off, file_upload, folder, folder_open, folder_shared, grid_view, request_quote, rule_folder, snippet_folder, text_snippet, topic, upload, upload_file, workspaces
...
arrow_left =
    icon
        [ v "0 0 24 24" ]
        [ p
            [ d "M24 0v24H0V0h24z", f "none", o ".87" ]
            []
        , p
            [ d "M14 7l-5 5 5 5V7z" ]
            []
...
border_color =
    icon
        ...
        , g
            []
            [ p
                [ d "M22,24H2v-4h20V24z M13.06,5.19l3.75,3.75L7.75,18H4v-3.75L13.06,5.19z M17.88,7.87 l-3.75-3.75l2.53-2.54l3.75,3.75L17.88,7.87z", b "new" ]
                []
            ]
        ]
    ...
    icon
        ...
        , g
            ...
            [ g
                []
                [ p
                    [ d "M10,17.62L17.62,10l-10-10L6.21,1.41l2.38,2.38L2.38,10L10,17.62z M10,5.21L14.79,10H5.21 L10,5.21z", b "new" ]
                    []
                , p
                    [ d "M19,17c1.1,0,2-0.9,2-2c0-1.33-2-3.5-2-3.5s-2,2.17-2,3.5C17,16.1,17.9,17,19,17z", b "new" ]
                    []
                , rect
                    [ b "new" ]
                    []
        ...
        , g
            ...
            [ g
                ...
                [ rect
                    ...
                    []
                , polygon
                    [ points "7.5,17.5 10.5,17.5 10.5,15 13,15 13,12 10.5,12 10.5,9.5 7.5,9.5 7.5,12 5,12 5,15 7.5,15" ]
                    []
                , p
                    [ d "M14,6H4C2.9,6,2,6.9,2,8v11c0,1.1,0.9,2,2,2h10c1.1,0,2-0.9,2-2V8C16,6.9,15.1,6,14,6z M14,19H4V8h10V19z" ]
                    []
                , p
                    [ d "M20,6c-1.68,0-3,1.76-3,4c0,1.77,0.83,3.22,2,3.76V20c0,0.55,0.45,1,1,1s1-0.45,1-1v-6.24c1.17-0.54,2-1.99,2-3.76 C23,7.76,21.68,6,20,6z M20,12c-0.41,0-1-0.78-1-2s0.59-2,1-2s1,0.78,1,2S20.41,12,20,12z" ]
                    []
                ]
            ]
        ]
    ...
    icon
        ...
        , g
            ...
            [ g
                []
                [ p
                    [ d "M15.11,12.45L14,10.24l-3.11,6.21C10.73,16.79,10.38,17,10,17s-0.73-0.21-0.89-0.55L7.38,13H2v7h20v-7h-6 C15.62,13,15.27,12.79,15.11,12.45z" ]
                    []
                , p
                    [ d "M22,4H2v7h6c0.38,0,0.73,0.21,0.89,0.55L10,13.76l3.11-6.21c0.37-0.74,1.42-0.74,1.79,0L16.62,11H22V4z" ]
                    []
                ]
            ]
        ]
...
no_encryption =
    icon
        [ v "0 0 24 24" ]
        [ p
            [ d "M0 0h24v24H0V0zm0 0h24v24H0V0zm0 0h24v24H0V0zm0 0h24v24H0V0z", f "none" ]
            []
        , p
    ...
    icon
        ...
        , g
            ...
            [ g
                []
                [ p
                    [ d "M21,6h-3V1H6v5H3v16h18V6z M8,3h8v3H8V3z M12,19c-2.76,0-5-2.24-5-5s2.24-5,5-5c2.76,0,5,2.24,5,5S14.76,19,12,19z" ]
                    []
                , polygon
