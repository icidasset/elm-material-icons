...
subway =
    icon
        [ viewBox "0 0 24 24" ]
        [ path
            [ fill "none", d "M0 0v24h24V0H0zm22 22H2V8.86C2 6.05 3.53 3.84 6.2 2.8 8 2.09 10.14 2 12 2c1.86 0 4 .09 5.8.8C20.47 3.84 22 6.05 22 8.86V22z" ]
            []
        , circle
            [ cx "15.5", cy "16", r "1" ]
            []
