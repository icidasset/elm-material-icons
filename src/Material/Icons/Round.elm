...
@docs add_comment, align_horizontal_center, align_horizontal_left, align_horizontal_right, align_vertical_bottom, align_vertical_center, align_vertical_top, attach_file, attach_money, bar_chart, border_all, border_bottom, border_clear, border_horizontal, border_inner, border_left, border_outer, border_right, border_style, border_top, border_vertical, bubble_chart, drag_handle, format_align_center, format_align_justify, format_align_left, format_align_right, format_bold, format_clear, format_color_reset, format_indent_decrease, format_indent_increase, format_italic, format_line_spacing, format_list_bulleted, format_list_numbered, format_list_numbered_rtl, format_paint, format_quote, format_shapes, format_size, format_strikethrough, format_textdirection_l_to_r, format_textdirection_r_to_l, format_underlined, functions, height, highlight, horizontal_distribute, horizontal_rule, insert_chart, insert_chart_outlined, insert_comment, insert_drive_file, insert_emoticon, insert_invitation, insert_link, insert_photo, linear_scale, merge_type, mode_comment, monetization_on, money_off, multiline_chart, notes, pie_chart, post_add, publish, scatter_plot, score, short_text, show_chart, space_bar, stacked_line_chart, strikethrough_s, subscript, superscript, table_chart, table_rows, text_fields, title, vertical_align_bottom, vertical_align_center, vertical_align_top, vertical_distribute, wrap_text
...
@docs check_box, check_box_outline_blank, indeterminate_check_box, radio_button_checked, radio_button_unchecked, star, star_border, star_half, star_outline, toggle_off, toggle_on
    ...
    icon
        ...
        , g
            ...
            [ g
                []
                [ path
                    [ d "M20,7v12c0,0.55-0.45,1-1,1H7c-0.55,0-1,0.45-1,1v0c0,0.55,0.45,1,1,1h13c1.1,0,2-0.9,2-2V7c0-0.55-0.45-1-1-1h0 C20.45,6,20,6.45,20,7z" ]
                    []
                , path
        ...
        , g
            ...
            , g
                ...
                [ path
                    ...
                    []
                , path
                    [ d "M20,3h-8c-1.1,0-2,0.9-2,2v6c0,1.1,0.9,2,2,2h8c1.1,0,2-0.9,2-2V5C22,3.9,21.1,3,20,3z M19.5,11h-7 c-0.28,0-0.5-0.22-0.5-0.5V7h8v3.5C20,10.78,19.78,11,19.5,11z" ]
                    []
                , path
    ...
    icon
        ...
        [ g
            ...
            , g
                []
                [ path
                    [ d "M19,13H5c-0.55,0-1-0.45-1-1v0c0-0.55,0.45-1,1-1h14c0.55,0,1,0.45,1,1v0 C20,12.55,19.55,13,19,13z", fillRule "evenodd" ]
                    []
                ]
            ]
        ]
...
maps_ugc =
    icon
        ...
        , path
            [ d "M12,8L12,8c-0.55,0-1,0.45-1,1v2H9c-0.55,0-1,0.45-1,1v0c0,0.55,0.45,1,1,1h2v2 c0,0.55,0.45,1,1,1h0c0.55,0,1-0.45,1-1v-2h2c0.55,0,1-0.45,1-1v0c0-0.55-0.45-1-1-1h-2V9C13,8.45,12.55,8,12,8z", fillRule "evenodd" ]
            []
        ]
    ...
    icon
        ...
        [ g
            ...
            [ path
                ...
                []
            , polygon
                [ fill "none", points "24,24 0,23.97 0,0 24,0.03" ]
                []
            ]
        ]
...
payments =
    icon
        ...
        [ g
            []
            [ path
                [ d "M0,0v24h24V0H0z M1,13V7c0-1.66,1.34-3,3-3h12c1.66,0,3,1.34,3,3v7c0,1.1-0.9,2-2,2H4C2.34,16,1,14.66,1,13z M23,18c0,1.1-0.9,2-2,2H5c-0.55,0-1-0.45-1-1c0-0.55,0.45-1,1-1h16V8c0-0.55,0.45-1,1-1s1,0.45,1,1V18z", fill "none" ]
                []
            , path
        ...
        , g
            ...
            , g
                ...
                [ g
                    []
                    [ path
                        [ d "M16.67,13.13C18.04,14.06,19,15.32,19,17v3h3c0.55,0,1-0.45,1-1v-2 C23,14.82,19.43,13.53,16.67,13.13z", fillRule "evenodd" ]
                        []
                    ]
                , g
                    []
                ...
                , g
                    []
                    [ path
                        [ d "M9,13c-2.67,0-8,1.34-8,4v2c0,0.55,0.45,1,1,1h14c0.55,0,1-0.45,1-1v-2 C17,14.34,11.67,13,9,13z", fillRule "evenodd" ]
                        []
                    ]
                ]
            ]
...
pin_drop =
    icon
        ...
        [ path
            ...
            []
        , path
            [ d "M6 20h12c.55 0 1 .45 1 1s-.45 1-1 1H6c-.55 0-1-.45-1-1s.45-1 1-1zm6-13c-1.1 0-2 .9-2 2s.9 2 2 2a2 2 0 1 0 0-4zm0-5c3.27 0 7 2.46 7 7.15 0 2.98-2.13 6.12-6.39 9.39-.36.28-.86.28-1.22 0C7.13 15.26 5 12.13 5 9.15 5 4.46 8.73 2 12 2z", fillRule "evenodd" ]
            []
        ]
    ...
    icon
        ...
        , g
            ...
            [ g
                []
                [ path
                    [ d "M14,10V3.26C13.35,3.09,12.68,3,12,3c-4.2,0-8,3.22-8,8.2c0,3.18,2.45,6.92,7.34,11.23c0.38,0.33,0.95,0.33,1.33,0 C17.55,18.12,20,14.38,20,11.2c0-0.41-0.04-0.81-0.09-1.2H14z M12,13c-1.1,0-2-0.9-2-2c0-1.1,0.9-2,2-2s2,0.9,2,2 C14,12.1,13.1,13,12,13z" ]
                    []
                , polygon
