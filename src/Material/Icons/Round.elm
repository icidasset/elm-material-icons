    ...
    icon
        ...
        , g
            ...
            [ g
                []
                [ path
                    [ d "M20.41,9c0.49,0,0.69-0.63,0.29-0.91L13.15,2.8c-0.69-0.48-1.61-0.48-2.29,0L3.3,8.09C2.9,8.37,3.1,9,3.59,9H11v12\n    \t\t\tc0,0.55,0.45,1,1,1s1-0.45,1-1V9H20.41z" ]
                    []
                , path
                    [ d "M8,16H4.9l-0.57-3.02c-0.1-0.54-0.62-0.9-1.17-0.8c-0.54,0.1-0.9,0.62-0.8,1.17L3,16.74V21c0,0.55,0.45,1,1,1h0.01\n    \t\t\tc0.55,0,1-0.44,1-0.99L5.02,18H7v3c0,0.55,0.45,1,1,1s1-0.45,1-1v-4C9,16.45,8.55,16,8,16z" ]
                    []
                , path
                    [ d "M20.84,12.18c-0.54-0.1-1.06,0.26-1.17,0.8L19.1,16H16c-0.55,0-1,0.45-1,1v4c0,0.55,0.45,1,1,1s1-0.45,1-1v-3h1.98\n    \t\t\tl0.02,3.01c0,0.55,0.45,0.99,1,0.99H20c0.55,0,1-0.45,1-1v-4.26l0.64-3.39C21.74,12.81,21.38,12.28,20.84,12.18z" ]
                    []
                ]
            ]
        ]
    ...
    icon
        ...
        , g
            ...
            [ g
                []
                [ path
                    [ d "M20.08,11.42l-4.04-5.65C15.7,5.29,15.15,5,14.56,5h0c-1.49,0-2.35,1.68-1.49,2.89L16,12l-2.93,4.11\n    \t\t\tc-0.87,1.21,0,2.89,1.49,2.89h0c0.59,0,1.15-0.29,1.49-0.77l4.04-5.65C20.33,12.23,20.33,11.77,20.08,11.42z" ]
                    []
                , path
                    [ d "M13.08,11.42L9.05,5.77C8.7,5.29,8.15,5,7.56,5h0C6.07,5,5.2,6.68,6.07,7.89L9,12l-2.93,4.11C5.2,17.32,6.07,19,7.56,19h0\n    \t\t\tc0.59,0,1.15-0.29,1.49-0.77l4.04-5.65C13.33,12.23,13.33,11.77,13.08,11.42z" ]
                    []
                ]
            ]
        ]
    ...
    icon
        ...
        , g
            ...
            , g
                []
                [ path
                    [ d "M7,8L7,8C6.45,8,6,8.45,6,9v6c0,1.1,0.9,2,2,2h8c0.55,0,1-0.45,1-1v0c0-0.55-0.45-1-1-1H8V9C8,8.45,7.55,8,7,8z" ]
                    []
                , path
                    [ d "M20,3h-8c-1.1,0-2,0.9-2,2v6c0,1.1,0.9,2,2,2h8c1.1,0,2-0.9,2-2V5C22,3.9,21.1,3,20,3z M19.5,11h-7\n    \t\t\tc-0.28,0-0.5-0.22-0.5-0.5V7h8v3.5C20,10.78,19.78,11,19.5,11z" ]
                    []
                , path
                    [ d "M3,12L3,12c-0.55,0-1,0.45-1,1v6c0,1.1,0.9,2,2,2h8c0.55,0,1-0.45,1-1v0c0-0.55-0.45-1-1-1H4v-6C4,12.45,3.55,12,3,12z" ]
                    []
                ]
            ]
        , g
    ...
    icon
        ...
        , g
            ...
            [ g
                ...
                []
            , path
                [ d "M11.99,2C6.47,2,2,6.48,2,12c0,5.52,4.47,10,9.99,10C17.52,22,22,17.52,22,12C22,6.48,17.52,2,11.99,2z M8.5,8\n    \t\tC9.33,8,10,8.67,10,9.5S9.33,11,8.5,11S7,10.33,7,9.5S7.67,8,8.5,8z M16.71,14.72C15.8,16.67,14.04,18,12,18s-3.8-1.33-4.71-3.28\n    \t\tC7.13,14.39,7.37,14,7.74,14h8.52C16.63,14,16.87,14.39,16.71,14.72z M15.5,11c-0.83,0-1.5-0.67-1.5-1.5S14.67,8,15.5,8\n    \t\tS17,8.67,17,9.5S16.33,11,15.5,11z" ]
                []
            ]
        ]
        ...
        , g
            ...
            , g
                ...
                [ circle
                    ...
                    []
                , path
                    [ d "M15.89,8.11C15.5,7.72,14.83,7,13.53,7c-0.21,0-1.42,0-2.54,0C8.53,6.99,6.48,5.2,6.07,2.85C5.99,2.36,5.58,2,5.09,2h0\n    \t\t\tc-0.61,0-1.09,0.54-1,1.14C4.53,5.8,6.47,7.95,9,8.71V21c0,0.55,0.45,1,1,1h0c0.55,0,1-0.45,1-1v-5h2v5c0,0.55,0.45,1,1,1h0\n    \t\t\tc0.55,0,1-0.45,1-1V10.05l3.24,3.24c0.39,0.39,1.02,0.39,1.41,0v0c0.39-0.39,0.39-1.02,0-1.41L15.89,8.11z" ]
                    []
                ]
            ]
        ]
    ...
    icon
        ...
        , g
            ...
            , g
                []
                [ path
                    [ d "M10,5H4C3.45,5,3,5.45,3,6c0,0.55,0.45,1,1,1h2v3c0,0.55,0.45,1,1,1s1-0.45,1-1V7h2c0.55,0,1-0.45,1-1\n    \t\t\tC11,5.45,10.55,5,10,5z" ]
                    []
                , path
                    [ d "M10,2H4C3.45,2,3,2.45,3,3s0.45,1,1,1h6c0.55,0,1-0.45,1-1S10.55,2,10,2z" ]
                    []
                , path
                    [ d "M20.89,13.11c-0.39-0.39-1.02-0.39-1.41,0l-6.36,6.36c-0.39,0.39-0.39,1.02,0,1.41c0.39,0.39,1.02,0.39,1.41,0l6.36-6.36\n    \t\t\tC21.28,14.13,21.28,13.5,20.89,13.11z" ]
                    []
                , circle
    ...
    icon
        ...
        , g
            ...
            [ g
                []
                [ path
                    [ d "M20,3h-8c-0.55,0-1,0.45-1,1v1.61c0,0,0,0,0.01,0.01l5,4.5C16.64,10.68,17,11.5,17,12.35V13h2v2h-2v2h2v2h-2v2h3\n    \t\t\tc0.55,0,1-0.45,1-1V4C21,3.45,20.55,3,20,3z M15,7h-2V5h2V7z M19,11h-2V9h2V11z M19,7h-2V5h2V7z" ]
                    []
                , path
                    [ d "M15,20v-7.65c0-0.28-0.12-0.55-0.33-0.74l-5-4.5C9.48,6.93,9.24,6.85,9,6.85c-0.24,0-0.48,0.09-0.67,0.26l-5,4.5\n    \t\t\tC3.12,11.79,3,12.06,3,12.35V20c0,0.55,0.45,1,1,1h2c0.55,0,1-0.45,1-1v-4h4v4c0,0.55,0.45,1,1,1h2C14.55,21,15,20.55,15,20z" ]
                    []
                ]
            ]
        ]
        ...
        , g
            ...
            , g
                ...
                [ g
                    []
                    [ path
                        [ fillRule "evenodd", clipRule "evenodd", d "M16.67,13.13C18.04,14.06,19,15.32,19,17v3h3c0.55,0,1-0.45,1-1v-2\n    \t\t\t\tC23,14.82,19.43,13.53,16.67,13.13z" ]
                        []
                    ]
                , g
                    []
                ...
                , g
                    []
                    [ path
                        [ fillRule "evenodd", clipRule "evenodd", d "M9,13c-2.67,0-8,1.34-8,4v2c0,0.55,0.45,1,1,1h14c0.55,0,1-0.45,1-1v-2\n    \t\t\t\tC17,14.34,11.67,13,9,13z" ]
                        []
                    ]
                ]
            ]
        ...
        , g
            ...
            [ g
                ...
                , circle
                    ...
                    []
                , path
                    [ d "M16,17H8c-0.55,0-1,0.45-1,1c0,0.55,0.45,1,1,1h1c1.1,0,2,0.9,2,2v1h2v-1c0-1.1,0.9-2,2-2h1c0.55,0,1-0.45,1-1\n    \t\t\tC17,17.45,16.55,17,16,17z" ]
                    []
                ]
            ]
        ]
    ...
    icon
        ...
        , g
            ...
            , g
                []
                [ path
                    [ d "M21.65,7.65l-2.79-2.79C18.54,4.54,18,4.76,18,5.21V7H4C3.45,7,3,7.45,3,8v0c0,0.55,0.45,1,1,1h14v1.79\n    \t\t\tc0,0.45,0.54,0.67,0.85,0.35l2.79-2.79C21.84,8.16,21.84,7.84,21.65,7.65z" ]
                    []
                , path
                    [ d "M2.35,16.35l2.79,2.79C5.46,19.46,6,19.24,6,18.79V17h14c0.55,0,1-0.45,1-1v0c0-0.55-0.45-1-1-1H6v-1.79\n    \t\t\tc0-0.45-0.54-0.67-0.85-0.35l-2.79,2.79C2.16,15.84,2.16,16.16,2.35,16.35z" ]
                    []
                ]
            ]
        ]
