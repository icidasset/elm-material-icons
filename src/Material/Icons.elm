...
cast =
    icon
        [ viewBox "0 0 24 24" ]
        [ path
            [ d "M0 0h24v24H0z", fill "none", Svg.Attributes.opacity ".1" ]
            []
        , path
            [ d "M0 0h24v24H0z", fill "none" ]
            []
    ...
    icon
        ...
        , g
            ...
            [ g
                []
                [ rect
                    [ Svg.Attributes.transform "matrix(0.7075 -0.7067 0.7067 0.7075 -5.6854 13.7194)" ]
                    []
                , rect
                    [ Svg.Attributes.transform "matrix(0.707 -0.7072 0.7072 0.707 0.3157 11.246)" ]
                    []
                , rect
                    [ Svg.Attributes.transform "matrix(0.7071 -0.7071 0.7071 0.7071 -8.1722 7.7256)" ]
                    []
                , rect
                    []
                    []
